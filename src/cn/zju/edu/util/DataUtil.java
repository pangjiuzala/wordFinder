...
public class DataUtil {
	 ...
	 * sc * (5 * i + j) + id1;// 根据id和数组下表递推的规律 b[i][j] =
	 * Double.parseDouble(sdd.getincrease(wz1, t1));
	 * System.out.println(b[i][j]); // 保存2015年10月12日的涨幅情况用于训练
	 * 
	 * }
	 * 
	 * } for (int t = 0; t <= 11; t++) {
	 ...
	 * }
	 * 
	 * // 获取实时数据测试集 public void getTestStockdata(String wz2, int id2) throws
